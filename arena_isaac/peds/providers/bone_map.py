...
skeleton-global rotation, signs baked to +1.0. Reserved y/r shoulder DOFs are
contract no-ops and map to None. Regenerated by
...
BONE_MAP: dict[str, tuple[BoneTarget, ...] | None] = {
