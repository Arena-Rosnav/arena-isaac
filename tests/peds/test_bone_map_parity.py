...
_PROBES: tuple[tuple[str, float, str], ...] = (
    ("r_waist", 0.4, "LowerBack"),
    ("y_waist", 0.5, "LowerBack"),
    ("waist", 0.5, "LowerBack"),
    ("r_spine", 0.3, "Spine"),
    ("y_spine", 0.4, "Spine"),
    ("spine", 0.4, "Spine"),
    ...
    ("y_head", 0.5, "Head"),
    ("p_head", 0.5, "Head"),
    ("l_y_collar", 0.4, "LeftShoulder"),
    ("l_p_collar", 0.4, "LeftShoulder"),
    ("l_y_shoulder", 0.5, "LeftArm"),
    ("l_p_shoulder", 0.5, "LeftArm"),
    ("l_r_shoulder", 0.5, "LeftArm"),
    ("l_elbow", 0.8, "LeftForeArm"),
    ("r_y_collar", 0.4, "RightShoulder"),
    ("r_p_collar", 0.4, "RightShoulder"),
